...
export const REQUEST_PLAYERSLIST = 'REQUEST_PLAYERSLIST';
export const RECEIVE_PLAYERSLIST = 'RECEIVE_PLAYERSLIST';
export const ERROR_RECEIVE_PLAYERSLIST = 'ERROR_RECEIVE_PLAYERSLIST';
