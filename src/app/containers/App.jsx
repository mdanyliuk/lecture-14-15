...
import PagePlayer from 'pageProviders/Player';
import PagePlayersList from 'pageProviders/PlayersList';
      ...
      <IntlProvider>
        ...
        {state.componentDidMount && (
            <Switch>
              ...
              <Route path={`/${PAGES.PLAYER}/:id`}>
                <PagePlayer />
              </Route>
              <Route path={`/${PAGES.PLAYER}`}>
                <PagePlayer />
              </Route>
              <Route path={`/${PAGES.PLAYERSLIST}`}>
                <PagePlayersList />
              </Route>
